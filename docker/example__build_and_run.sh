...
#unset the variables
unset TOMCAT_EXTERNAL_PORT=<a_port_on_which_your_service_shall_be_visible_to_the_outside_world>
unset MYSQL_DOCKER_ROOT_PASSWORD=<a_root_password>
unset MYSQL_DOCKER_USER_PASSWORD=<a_user_password>
unset MYSQL_DOCKER_DATABASE=genesis_project
unset MYSQL_DOCKER_USER=genesis_project